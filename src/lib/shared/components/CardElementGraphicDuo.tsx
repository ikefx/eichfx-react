    ...
    return (
        <>
            <div className="row mt-4 mx-0">
                <img src={properties.imgUri1} alt="img" loading="lazy" className={'col-6 shadow rounded-0 rounded-start p-0'}/>
                <img src={properties.imgUri2} alt="img" loading="lazy" className={'col-6 shadow rounded-0 rounded-end p-0'}/>
